...
int main(int argc, char *argv[])
{
    ...
    do {
        ...
        if ( Program[Position] == "N" ) { if ( Register1 == Register2 ) Position = Register4[1] ;}
        if ( Program[Position] == "O" ) { if ( Register1 != Register2 ) Position = Register4[1] ;}
        if ( Program[Position] == "P" ) { if ( Register1 >= Register2 ) Position = Register4[1] ;}
        if ( Program[Position] == "Q" ) { if ( Register1 <= Register2 ) Position = Register4[1] ;}
        if ( Program[Position] == "R" ) { if ( Register3 == 0 ) Position = Register4[1] ;}
